  ...
  bestDepartment() {
    ...
    for (const department in this.departments) {
      this.departments[department].avgSalary =
        this.departments[department].employees.reduce(
          (a, b) => a + b.salary,
          0
        ) / this.departments[department].employees.length || 0;
